...
TaskDistviewBinsTbb::TaskDistviewBinsTbb(QString id, QString target,
                                         std::map<QString, SourceDeclaration> sources,
                                         std::vector<multi_img::Value> &illuminant)
    : Task(id, target, sources), illuminant(illuminant)
{}
...
void TaskDistviewBinsTbb::expression(bool subtract, std::vector<cv::Rect> &collection,
                                     const multi_img &multi, std::vector<BinSet> &sets,
                                     const cv::Mat1s& labels,
                                     const cv::Mat1b& mask,
...
void TaskDistviewBinsTbb::createBinSets(const multi_img &      multi,
...
void TaskDistviewBinsTbb::updateContext(const multi_img &multi, ViewportCtx *args)
{
