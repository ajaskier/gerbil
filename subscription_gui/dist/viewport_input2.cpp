...
void Viewport2::mouseMoveEvent(QGraphicsSceneMouseEvent *event)
{
...
void Viewport2::mousePressEvent(QGraphicsSceneMouseEvent *event)
{
...
void Viewport2::mouseReleaseEvent(QGraphicsSceneMouseEvent *event)
{
	// check for scene elements first (we are technically the background)
...
void Viewport2::wheelEvent(QGraphicsSceneWheelEvent *event)
{
	// check for scene elements first (we are technically the background)
...
void Viewport2::keyPressEvent(QKeyEvent *event)
{
	// check for scene elements first (we are technically the background)
